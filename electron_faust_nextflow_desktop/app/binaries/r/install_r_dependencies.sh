...
R_EXECUTABLE_ABSOLUTE_FILE_PATH="${CURRENT_DIRECTORY}/${R_VERSION_FINAL_ARTIFACT_DIRECTORY_RELATIVE_PATH}/bin/R"
R_SCRIPT_EXECUTABLE_ABSOLUTE_FILE_PATH="${CURRENT_DIRECTORY}/${R_VERSION_FINAL_ARTIFACT_DIRECTORY_RELATIVE_PATH}/bin/Rscript"
...
# exec $R_SCRIPT_EXECUTABLE_ABSOLUTE_FILE_PATH --vanilla \
#     --verbose \
#     $R_DEPENDENCIES_INSTALL_ABSOLUTE_FILE_PATH
